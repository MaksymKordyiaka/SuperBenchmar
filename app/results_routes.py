...
async def get_average_for_time_range(start_time: str = Path(example="2024-06-01 12:00:00", description="Start date and time in format: YYYY-MM-DD HH:MM:SS"), end_time: str = Path(example="2024-06-01 13:00:00", description="End date and time in format: YYYY-MM-DD HH:MM:SS")):
    results = load_data()
